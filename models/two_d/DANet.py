...
__all__ = ['PAM_Module', 'CAM_Module', 'DANet', 'get_danet']
...
class BaseNet(nn.Module):
    def __init__(self, nclass, backbone, aux, se_loss, dilated=True, norm_layer=None,
        ...
        #                                *args, **kwargs)
        self.pretrained = ResNet(layers=[3, 4, 23, 3])
...
class DANet(BaseNet):
    ...
    def __init__(self, nclass, backbone='resnet50', aux=False, se_loss=False, norm_layer=nn.BatchNorm2d, **kwargs):
    ...
    def forward(self, x):
        ...
        return (outputs[0] + outputs[1] + outputs[2]) / 3
